...
<jsp:include page="${pageContext.request.contextPath}/WEB-INF/views/admin/admin_header.jsp">
	<jsp:param value="블라인드 댓글" name="title" />
</jsp:include>
<style>
.container {
	width: 600px;
		...
		<table class="table table-slit w-100">
			...
			<tbody class="center">
				<c:forEach var="list" items="${list}">
					<tr>
						<td width="10%">${list.replyBlindNo}</td>
						<td width="20%">${list.replyNo}</td>
					    <td width="30%">${list.memNick}</td>
					    <td width="20%">${list.blindReportCnt}</td>
					    <td width="20%">
					    	<a href="${pageContext.request.contextPath}/admin/blind/reply/detail?replyNo=${list.replyNo}">
